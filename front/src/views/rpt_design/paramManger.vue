    ...
    <div>
            ...
            <draggable tag="ul"
                    ...
                    <i class="drag-item el-icon-s-operation"
                        ...
                        <div @click="action_target=item"  style="display: inline-block;width:calc(100% - 50px)">
                            {{item._name}} 
                        </div>
        ...
        <el-form :inline="true" class="demo-form-inline" v-if="action_target">
            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item v-if="action_target._data_type=='datetime'" label="日期格式"><el-input v-model="action_target._dateTimeFormat" placeholder="日期格式"></el-input></el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row v-if="action_target._hide=='False' && action_target._inner=='False' && action_target._data_type!='date' && action_target._data_type!='datetime'"><el-col :span="24">
                <el-tabs v-model="action_target._defaultValueFrom"
                        stretch
                    ...
                    <el-tab-pane label="数据集" name="Query">
                         ...
                         <el-select v-model="action_target._dataSetName_kyz">
                        ...
                        <template v-if="action_target._dataSetName_kyz && report.dataSets.dataSet.find(x=>x._name==[action_target._dataSetName_kyz])._fields">
                            ...
                            <el-select v-model="action_target._valueField_kyz" >
                            ...
                            <el-select v-model="action_target._parent_valueField_kyz" >
                                <el-option v-for="(ds,idx) in JSON.parse(report.dataSets.dataSet.find(x=>x._name==[action_target._dataSetName_kyz])._fields)" 
                                    :key="ds+idx" :label="ds" :value="ds"></el-option>
                            </el-select>
                            </el-form-item>
    ...
    methods:{
        ...
        new_param(new_name){
            return {_name:new_name,_prompt:new_name,_data_type:'string',_width:'',
                ...
                _canUsedValueFrom:'',_dataSetName_kyz:'',_valueField_kyz:'',_parent_valueField_kyz:'',
                _tagField_kyz:'',_tagValueList:'',_defaultValueFrom:'noneQuery',
